 ...
 * @method        EmbeddedMoneyModifier plus(MoneyInterface|AbstractMoney|BigNumber|int|float|string $that, int $roundingMode = null)
 * @method        EmbeddedMoneyModifier minus(MoneyInterface|AbstractMoney|BigNumber|int|float|string $that, int $roundingMode = null)
 * @method        EmbeddedMoneyModifier multipliedBy(BigNumber|int|float|string $that, int $roundingMode = null)
 * @method        EmbeddedMoneyModifier dividedBy(BigNumber|int|float|string $that, int $roundingMode = null)
 * @method        EmbeddedMoneyModifier toZero()
 * @method        EmbeddedMoneyModifier abs()
 * @method        EmbeddedMoneyModifier negated()
 */
#[ORM\Embeddable]
